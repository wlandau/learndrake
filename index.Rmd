...
- Why use functions?
  ...
  2. Reuse: define once, run wherever.

---

## <img src="./images/yes.png" width="60" height="40"> Functions in a workflow
...
- **Think of an example of a nontrivial function.**
- From a math PhD oral exam, but requires no math.
