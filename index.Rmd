...
An accessible, ubiquitous, standard way to address this problem is to write functions.
...
For example, you'll notice that you're being truer to the process of data analysis itself. Functions are **fundamentally designed** to describe change. They are **designed** to transform things into other things. And in our workflows, we change raw data into clean data, clean data into model output, and so on. Those steps are *begging* to be functions.
