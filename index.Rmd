...
Also, I said all that stuff about functions because of what I learned from Ellis Hughes, Pat Schratz, and Stas Kolenikov. They helped me see workflows how other people were seeing them. When I was in school, I took most of my computer science before most of my statistics, so I totally took functions for granted, and that made it super hard to explain `drake` in the early days. But thanks to people like them, I think I'm getting better.
