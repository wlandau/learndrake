...
Did creating the [plan](https://ropenscilabs.github.io/drake-manual/plans.html) actually run the workflow? Hint: [`cached()`](https://docs.ropensci.org/drake/reference/cached.html).
