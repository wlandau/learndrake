...
When you call [`make(plan)`](https://ropensci.github.io/drake/reference/make.html) in your R console, which target runs *first*? Why?
...
When you called [`make(plan)`](https://ropensci.github.io/drake/reference/make.html) in the previous exercise, which target ran *last*? Why?
...
Run [`make(plan)`](https://ropensci.github.io/drake/reference/make.html) again. What happens?
...
Now, run `R/functions.R` and then run [`make(plan)`](https://ropensci.github.io/drake/reference/make.html) again.
...
Save `R/plan.R`, source it, and run [`make(plan)`](https://ropensci.github.io/drake/reference/make.html) again. Which targets rebuild, if any?
...
Save and run `R/functions.R` and then run [`make(plan)`](https://ropensci.github.io/drake/reference/make.html).
...
Delete the last record of `../data/customer_churn.csv` and run [`make(plan)`](https://ropensci.github.io/drake/reference/make.html) again. Which targets  rebuild? Why?
