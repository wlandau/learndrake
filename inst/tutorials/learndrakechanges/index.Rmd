---
title: "Change management in drake workflows"
...
In your working directory (should be `3-changes`) there should be an `R/` folder with 3 scripts.
...
question(
  ...
  answer("A data frame."),
  answer("A recipe."),
  answer("A Keras model.", correct = TRUE),
  answer("A function.")
)
```
