...
Look, nothing is going to change the fact that writing code is difficult. It will always be difficult. For everyone. Not even the Tidyverse or R Markdown can replace the fact that every single one of us has to concentrate and get our thoughts in order. And if you feel this, you are **not** an imposter, you are self-aware. And the more we lean into it, the better off we'll be in the long run. Functions, and `drake`, force us to think clearly about what we're doing.

Once you do this, you'll notice benefits pretty quickly. One thing you'll notice is that you're being true to the process of data analysis. Functions are a universal tool to describe how things change into other things. And that's exactly what we do when we analyze data. We change raw data into clean data, clean data into model output, and so on.
