...
plan <- drake_plan(
  ...
  churn_data = read_csv(
    ...
    initial_split(prop = 0.3),
  run_relu = train_model(churn_recipe, act1 = "relu"), #<<
  run_sigmoid = train_model(churn_recipe, act1 = "sigmoid") #<<
)
```
...
```{r}
readd(run_relu) # model training history
```
...
plan <- drake_plan(
  ...
  run_relu = train_model(churn_recipe, act1 = "relu"),
  run_sigmoid = train_model(churn_recipe, act1 = "sigmoid"),
  run_softmax = train_model(churn_recipe, act1 = "softmax") #<<
)
```
