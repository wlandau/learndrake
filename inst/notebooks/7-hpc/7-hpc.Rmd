...
Above, `caching = "worker"` tells `drake` to save the models in the workers instead of the master process. This is important for Keras because a model is no longer valid if you simply send it to another R process. Other workarounds:
