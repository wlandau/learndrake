...
```{r, include = FALSE}
# Set your working directory to 1-churn/.
# You may have to copy and paste this line into your console:
setwd(file.path(rprojroot::find_rstudio_root_file(), "1-churn"))
source("../config/options.R")
```

# Preparation for `drake`

These exercises set up the building blocks of a `drake`-powered data analysis workflow. The goal is to establish the necesary packages, data, *user-defined functions*, and context of the case study.
